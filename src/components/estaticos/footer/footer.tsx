...
function Footer() {
  return (
    <>
        <Grid container direction="row" justifyContent="center" alignItems="center" color="primary">
            <Grid alignItems="center" item xs={12}>
                <Box className='footer-box1'>
                    ...
                    <Box display="flex" alignItems="center" justifyContent="center">
                        <a href="https://github.com/Deekahass" target="_blank">
                            <GithubIcon className='redes-sociais github' />
                        </a>
                        <a href="https://www.linkedin.com/in/andreza-silvestre/" target="_blank">
